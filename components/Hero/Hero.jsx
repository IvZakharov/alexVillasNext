      ...
      <section className={`container p-0`}>
          <div className={styles.hero}>
              ...
              <div className={`${styles.h1Block} mx-auto`}>
                  <h1 className={styles.h1}>{h1first}<br /><span>{h1second}</span></h1>
                  <FormContactHero hrefLabel={"PICK YOUR INVESTMENT TYPE"}/>
                  {text !== null ?  <div className={styles.textBlock}> <div className={styles.text}>{text}</div></div>: ''}
                  {subLable !== null ? <div className={styles.subLable}>{subLable}</div>: ''}
              </div>
